...
class Reporter {
    ...
    buildRequestData(stage, sanitizer) {
        ...
        return Object.assign(Object.assign({}, fullData), { method, path: sanitizer.sanitize(path), url: buildUrl(connection, request, sanitizer) });
    }
