...
exports.intercept = (module) => {
    ...
    const request = function (urlOrOptions, optionsOrCallback, callback) {
        ...
        try {
            ...
            const { options, method, parsedQuery } = extractedRequest;
             ...
             */
            const requestData = { method, headers: options.headers, params: parsedQuery, path: options.path };
            ...
            if (ruleManager.timeoutRemediation) {
                ...
                req.setTimeout(duration, () => {
                    req.emit('error', new errors_1.RequestTimeout(duration, options.hostname));
                    req.abort();
                });
            }
